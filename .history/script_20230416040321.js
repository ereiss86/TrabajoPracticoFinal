...
function codigoDesc() {
  ...
  document.getElementById('Cupon').innerHTML= `<div id="cupon"><h1 class="text-center">Disfruta tu cupon de descuento</h1><p class="mt-5 py-5 text-center col-12 cuponL">`+codigo+`</p></div>`;
}
