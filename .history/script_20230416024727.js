...
function codigoDesc() {
  ...
  document.getElementById('Cupon').innerHTML= `<div class="w-md-50" id="regForm">
  <figure>
  <img src="Imagenes/promo.png alt="Descripción de la imagen">
  <figcaption>Texto que se mostrará sobre la imagen</figcaption>
</figure><p>`+codigo+`</p></div>`;
}
