...
function showTab(tabIndex) {
    ...
    if (tabIndex !== (tabs.length - 1)) {
        ...
        imprimirBtn.style.display = "inline";
    }
    ...
    if (tabIndex === (tabs.length - 2)) {
        ...
        nextBtn.innerHTML = "Enviar pedido";
        prevBtn.style.display = "none";
    } else {
...
function validateForm() {
    const tabs = document.querySelectorAll(".tab");
    const inputs = tabs[currentTabIndex].querySelectorAll("input");
    let valid = true;
    ...
    if (valid) {
        document.getElementsByClassName("step")[currentTabIndex].className += " finish";
    }
...
$(document).ready(function(){
    $("#imprimir").click(function(){
      $('#nombre, #apellido, #email, #telefono, #direccion, #cp, #localidad, #provincia, #mensaje').printThis({
