...
function codigoDesc() {
  ...
  document.getElementById('Cupon').innerHTML= `<h1 class="text-light text-center pb-3"></h1><br><div id="cupon"><p class="mt-5 py-5 text-center col-12 cuponL">`+codigo+`</p></div>`;
}
