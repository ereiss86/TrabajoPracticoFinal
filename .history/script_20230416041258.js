...
function codigoDesc() {
  ...
  document.getElementById('Cupon').innerHTML= `<h2 class="text-light text-center pt-3">DISFRUTA TU CUPÓN DE DESCUENTO</h1><br><div id="cupon"><p class="mt-5 py-5 text-center col-12 cuponL">`+codigo+`</p></div>`;
}
